...
* [6章 純粋関数型の状態](blob/master/doctree/chapter06.md)

#### part2 関数型デザインとコンビネータライブラリ
* [7章 純粋関数型の並列処理](blob/master/doctree/chapter07.md)
* [8章 プロパティベースのテスト](blob/master/doctree/chapter08.md)
* [9章 パーサーコンビネータ](blob/master/doctree/chapter09.md)

#### part3 関数型デザインに共通する構造
* [10章 モノイド](blob/master/doctree/chapter10.md)
* [11章 モナド](blob/master/doctree/chapter11.md)
* [12章 アプリカティブファンクタとトラバーサブルファンクタ](blob/master/doctree/chapter12.md)
